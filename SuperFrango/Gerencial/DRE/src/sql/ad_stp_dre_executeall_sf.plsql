...
begin
  ...
  */
  ...
  begin
    ...
    dbms_output.put_line('Base de custos na referencia');
  ...
  begin
    ...
    dbms_output.put_line('Indicadores gerenciais calculados!');
  ...
  begin
    ...
    dbms_output.put_line('Indicadores padrões criada!');
