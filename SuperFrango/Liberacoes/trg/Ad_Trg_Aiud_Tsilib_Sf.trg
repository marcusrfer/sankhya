				...
				If :New.Tabela = 'AD_JURITE' Then
						...
						Begin
								...
								Mail.Mensagem := '<br> Uma nova solicitação de liberação para pagamento de despesas juridicas, ' ||
																									...
																									'(pasta nro ' || :New.Nuchave || ', sequência ' || :New.Sequencia ||
						...
						Begin
								...
								Values
										(Nvl((Select Max(Codfila) From Ad_Filanotificacaopush), 0) + 1, :New.Codusulib, 1,
											'Nova liberação de limites solicitada', Sysdate, 'P');
						Exception
								When Others Then
				...
				Begin
						...
						Values
								(:New.Nuchave, :New.Tabela, :New.Dhsolicit, :New.Dhlib, :New.Codususolicit, :New.Codusulib,
									v_Codusulog, :New.Vlratual, :New.Vlrliberado, :New.Evento, :New.Observacao, :New.Obslib, 'Inclusão',
        ...
        */
		...
		If Deleting Then
				...
				Begin
						...
						Values
								(:Old.Nuchave, :Old.Tabela, :Old.Dhsolicit, :Old.Dhlib, :Old.Codususolicit, :Old.Codusulib,
									v_Codusulog, :Old.Vlratual, :Old.Vlrliberado, :Old.Evento, :Old.Observacao, :Old.Obslib, 'Exclusão',
									Sysdate, Ad_Seq_Tsilib_Log.Nextval);
				Exception
						When Others Then
								Errmsg := 'Erro ao gravar o log da exclusão da liberação. ' || Sqlerrm;
