...
Begin
	...
	If r_Fin.Numdupl Is Not Null Then
		Begin
			Select f.Tipacerto Into v_Tipacerto From Tgffre f Where f.Nufin = r_Fin.Nufin;
		Exception
		...
		Loop
			...
			For c_Lib In (Select *
											From (Select l.Tabela,
														...
														Select 'TGFCAB' Tabela,
																	 r.Nunota Nuchave,
																	 Con.Dhfinalconf Dhlib,
																	 Con.Codusu As Codusulib,
																	 1037 Evento,
																	 ' - ' Suplente
