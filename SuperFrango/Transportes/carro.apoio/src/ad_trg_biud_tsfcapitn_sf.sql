...
begin
  ...
  */
  ...
  if inserting or updating or deleting then
    ...
    select c.status into v_status from ad_tsfcapsol c where c.nucapsol = nvl(:new.nucapsol, :old.nucapsol);
    ...
    begin
      update ad_tsfcapsol c set c.dhalter = sysdate where c.nucapsol = nvl(:new.nucapsol, :old.nucapsol);
    exception
      when others then
        raise;
    end;
