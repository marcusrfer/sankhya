create or replace procedure ad_stp_dre_calcindger_sf(p_codusu    number,
                                                     p_idsessao  varchar2,
                                                     p_qtdlinhas number,
...
begin
  ...
  */
  ...
  v_time := to_char(to_date(t, 'sssss'), 'hh24:mi:ss');

  p_mensagem := 'Indicadores ' || p_referencia || ' calculados com sucesso!!!<br> ' || ' Temp de execução: ' || v_time;
