...
begin
  ...
  */
  ...
  begin
    ...
    lote := ad_pkg_fci.get_dados_lote(l.numlote); -- lote avecom 
    ad_pkg_fci.get_dados_fechamento(l.numlote, l, c); -- fci e conf
        ...
        if p_tipobonif = 'M' then
          ...
          begin
            ...
            b.obs := 'Utilizando tabela ' || t.codtab || '/' || t.codemp || ', custo da ave de 0' ||
                     fmt.numero(p_vlrcusto) || ' e com ajuda extra de ' ||
                     fmt.numero(p_vlrbnfpinto);
          ...
          begin
            ...
            b.obs        := 'Utilizando tabela ' || t.codtab || '/' || t.codemp ||
                            ', custo da ave de 0' || fmt.numero(p_vlrcusto) || ' e com ajuda de ' ||
                            fmt.numero(p_vlrbnfpinto);
