    ...
    if p_tipobonif = 'M' then
     ...
     begin
      ...
      insert into ad_tsffcibnf
       (numlote, nufcibnf, tipobonif, percmortprev, qtdmortprev, saldoprev, percmortreal,
        qtdmortreal, saldoreal, qtdavesbnf, percavesbnf, viabilidade, percmortlote,
        perccom, vlrcom, vlrunitcom, vlrbonific, vlrunitbnf, aprovado, obs)
      values
     ...
     begin
      ...
      insert into ad_tsffcibnf
       (numlote, nufcibnf, tipobonif, percmortprev, qtdmortprev, saldoprev, percmortreal,
        qtdmortreal, saldoreal, qtdavesbnf, percavesbnf, viabilidade, percmortlote,
        perccom, vlrcom, vlrunitcom, vlrbonific, vlrunitbnf, aprovado)
      values
