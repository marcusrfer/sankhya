 ...
 */
 function calculajuro(p_tipo char, p_valor float, p_taxa float, p_prazo float) return float;
 ...
 *****************************************************************************/
 function get_cgccpf_parcemp(p_codparcemp number, p_tipo char) return varchar2;

 function codcidparcemp(pcodigo number, ptipo char) return number;
 ...
 *****************************************************************************/
 ...
 function dadosordcarga(p_codemp number, p_ordcarga number, p_tipo char) return number;
 /****************************************************************************
 Autor: Marus Rangel
 ...
 *****************************************************************************/
 ...
 function dadoscontato(p_codparc number, p_codcontato number, p_tipo char) return varchar deterministic; -- Por Ricardo - Retorna dados da Tddpco

 function dados_tddpco(p_nucampo number, p_nome varchar) return varchar;

 function datavencimento(pdtnegociacao date, p_usarparametro char := 'S') return date;
 /****************************************************************************
 Autor: 
 Objetivo: 
 *****************************************************************************/
 ...
 */
 ...
 function dia_util_ultimo(dt_base in date, ptipo in char) return date;

 function distanciacidade(p_cidorigem int, p_ciddest int) return float;
 /****************************************************************************
 Autor: Marcus Rangel
 ...
 *****************************************************************************/
 ...
 function enderecocompleto(ptipo char, pcodigo number, pcodigo2 number) return varchar2;
 /****************************************************************************
 Autor: Marcus Rangel
 ...
 *****************************************************************************/
 ...
 function nomeusu(pcodusu number, ptipo varchar2) return varchar2 deterministic;
 /****************************************************************************
 Autor: Marcus Rangel
 Objetivo: Retornar o nome do usuário, completo ou resumido
 *****************************************************************************/

 function nuchavedest(p_taborig varchar2, p_nuchaveorig number) return varchar2;
 /****************************************************************************
 Autor: Marcus Rangel
 ...
 *****************************************************************************/
 ...
 function opcoescampo(p_valor varchar, p_nomecampo varchar, p_nometab varchar) return varchar deterministic;
 /****************************************************************************
 Autor: Marcus Rangel
 Objetivo: Retornar os valores de campos do tipo lista
 *****************************************************************************/

 function qtdlibpend(p_nuchave number, p_tabela varchar, p_sequencia int) return number;
 /****************************************************************************
 Autor: 
 Objetivo: 
 *****************************************************************************/
 ...
 *****************************************************************************/
 ...
 function ufparcemp(pcodigo number, ptipo char) return number;
 /****************************************************************************
 Autor:     Ricardo Soares de Oliveira
 Objetivo:  Busca a UF do parceiro ou da empresa:
            ...
            pTipo   - P = Parceiro 
                      ...
                      E = Empresa
 *****************************************************************************/
 procedure get_next_cod_tgfnum(p_tabela varchar2, p_codemp number, p_serie char, p_proxcod out number);

 function ultcod(p_tabela varchar2, p_codemp number, p_serie char) return number;
 /****************************************************************************
 Autor: Marcus Rangel
 ...
 *****************************************************************************/
 ...
 function temlib(p_nufin number, p_tabela varchar2) return number;
 function temlib(p_nufin number, p_tabela varchar2, p_sequencia int, p_evento number) return number;
 /****************************************************************************
 ...
 *****************************************************************************/
 ...
 function tipmovtop(pcodtop number, pdhtipoper date) return char;
 /****************************************************************************
 Autor: 
 Objetivo: 
 *****************************************************************************/
 ...
 *****************************************************************************/
 ...
 function totcontrato(p_numcontrato number, p_tipo varchar2) return float;
 /****************************************************************************
 Autor: 
 Objetivo: 
 *****************************************************************************/
 ...
 *****************************************************************************/
 ...
 function horasuteis(p_dataini timestamp, p_datafin timestamp) return float;
 /****************************************************************************
 Autor: Marcus Rangel
 ...
 *****************************************************************************/
 ...
 function subtrai_hora_acidente(p_dtacid date, p_hrtrabalho varchar2) return varchar2;

 /****************************************************************************
 Autor: Gusttavo Lopes
 Objetivo: retornar o ultimo valor da moeda a partir de uma data especifica
 *****************************************************************************/
 function moeda(p_codmoeda int, p_dtmoeda date) return float;
 ...
 */
 ...
 function custo_produto(p_codprod in number, p_codemp in number, p_data in date, p_tipo in number)
  return float;
 ...
 */
 ...
 function removerduplicidade(p_texto varchar2, p_caracter char) return varchar2;

 function valorprodcontrato(p_numcontrato number, p_codprod number) return float;

 function nome_parceiro(p_codparc number, p_tiponome varchar2) return varchar2;

 function aliq_piscofins(p_codprod number, p_nomeimp varchar2, p_top number) return float;

 function ultimo_valor_contrato(p_numcontrato number, p_codprod number, p_data date) return float;
 ...
 function cotacao_moeda(p_codmoeda number, p_dtref date) return float;

 function cr_do_usuario(p_codusu number) return number;
 function meses_entre_datas(p_dtini date, p_dtfin date) return number;

 function nomeempresa(p_codemp number) return varchar2;

 function ult_valor_moeda_ref(p_codmoeda int, p_dtref date) return float;
 ...
 */
 ...
 function calculajuro(p_tipo char, p_valor float, p_taxa float, p_prazo float) return float is
  v_vlrjuro float;
 begin
  if p_tipo = 'S' then
 ...
 */
 ...
 function codcidparcemp(pcodigo number, ptipo char) return number is
  vcodcid number;
 begin
  if ptipo = 'P' then
 ...
 *****************************************************************************/
 ...
 function dadosordcarga(p_codemp number, p_ordcarga number, p_tipo char) return number is
  v_result number;
 begin
  if p_tipo = 'V' then
   select o.codveiculo
 ...
 function dados_tddpco(p_nucampo number, p_nome varchar) return varchar as
  v_valor varchar2(20);
 
 begin
  begin
   select decode(o.valor,
                  'default',
                  'Padrão',
                  'mult-list',
                  'Multi Seleção',
 ...
 -- Por Ricardo Soares 30/09/2019 - retorna informacoes contato TGFCTT
 function dadoscontato(p_codparc number, p_codcontato number, p_tipo char) return varchar deterministic as
 ...
 function datavencimento(pdtnegociacao date, p_usarparametro char := 'S') return date is
 ...
 begin
  ...
  vvalida := vqtddiasparametro + (case
              when to_number(to_char(to_date(to_char(pdtnegociacao + vqtddiasparametro, 'DDMMYYYY'), 'DDMMYYYY'),
                                     'D')) = 7 then
               2
              when to_number(to_char(to_date(to_char(pdtnegociacao + vqtddiasparametro, 'DDMMYYYY'), 'DDMMYYYY'),
                                     'D')) = 1 then
 ...
 begin
  ...
  select l.descrlocal into v_descrlocal from tgfloc l where l.codlocal = p_codlocal;
 ...
 */
 ...
 function dia_util_ultimo(dt_base in date, ptipo in char) return date as
 ...
 function distanciacidade(p_cidorigem int, p_ciddest int) return float is
  vdistancia float;
 begin
  begin
   select distancia
 ...
 function enderecocompleto(ptipo char, pcodigo number, pcodigo2 number) return varchar2 is
  ...
  if ptipo = 'P' and nvl(pcodigo2, 0) = 0 then
   select end1.tipo || ' ' || ltrim(rtrim(end1.nomeend)) || case
           when par.numend is not null then
            ...
            ''
          end || ltrim(rtrim(par.complemento)) || ' - ' || bai.nomebai || ', ' || cid.nomecid || ' - ' ||
          ufs.uf || ' CEP: ' || par.cep
     into vendereco
     from tgfpar par
 ...
 begin
  if length(pcampo) = 11 then
   vcnpjcpf := regexp_replace(lpad(pcampo, 11, '0'),
                              '([0-9]{3})([0-9]{3})([0-9]{3})([0-9]{2})',
                              '\1.\2.\3-\4');
  end if;
  if length(pcampo) = 14 then
   vcnpjcpf := regexp_replace(lpad(pcampo, 14, '0'),
 ...
 *****************************************************************************/
 ...
 function nomeusu(pcodusu number, ptipo varchar2) return varchar2 deterministic is
 ...
 function nuchavedest(p_taborig varchar2, p_nuchaveorig number) return varchar2 is
 ...
 function opcoescampo(p_valor varchar, p_nomecampo varchar, p_nometab varchar) return varchar deterministic as
 ...
 function qtdlibpend(p_nuchave number, p_tabela varchar, p_sequencia int) return number is
 ...
 function ufparcemp(pcodigo number, ptipo char) return number as
  vvalor number;
 begin
  --uf do parceiro
  if ptipo = 'P' then
 ...
 procedure get_next_cod_tgfnum(p_tabela varchar2, p_codemp number, p_serie char, p_proxcod out number) is
  stmt        varchar2(4000);
  v_count     int := 0;
 ...
 begin
  ...
  stmt := 'Update TGFNUM set ultcod = ' || p_proxcod || ' where arquivo = ''' || p_tabela ||
          '''and codemp = ' || p_codemp || ' and serie = ''' || p_serie || '''';
 ...
 function ultcod(p_tabela varchar2, p_codemp number, p_serie char) return number is
  v_ultcod number;
 begin
 ...
 function temlib(p_nufin number, p_tabela varchar2) return number is
  result number;
  pragma autonomous_transaction;
 begin
  select count(*)
 ...
 function temlib(p_nufin number, p_tabela varchar2, p_sequencia int, p_evento number) return number is
  result number;
  --Pragma Autonomous_Transaction;
 begin
  select count(*)
 ...
 function ticketvenda(p_codparc int, p_tipo varchar2) return float is
  v_ticketvenda float;
 ...
 *****************************************************************************/
 ...
 function tipmovtop(pcodtop number, pdhtipoper date) return char is
  vtipmov char;
 begin
  select tipmov
    into vtipmov
 ...
 function totcontrato(p_numcontrato number, p_tipo varchar2) return float is
  v_tot float;
 begin
 ...
 begin
  if length(pcgc_cpf) = 14 then
   vcgc_cpf := regexp_replace(pcgc_cpf,
                              '([0-9]{2})([0-9]{3})([0-9]{3})([0-9]{4})([0-9]{2})',
                              '\1.\2.\3/\4-\5');
 ...
 function get_cgccpf_parcemp(p_codparcemp number, p_tipo char) return varchar2 is
 ...
 function horasuteis(p_dataini timestamp, p_datafin timestamp) return float is
  d1       date;
  d2       date;
  c1       int := 0;
  c2       int := 0;
 ...
 function subtrai_hora_acidente(p_dtacid date, p_hrtrabalho varchar2) return varchar2 is
  result varchar2(4);
 begin
 ...
 function moeda(p_codmoeda int, p_dtmoeda date) return float is
  v_vlrmoeda float;
 begin
 ...
 *****************************************************************************/
 ...
 begin
  ...
  select nvl(cusrep, 0), nvl(cusger, 0), nvl(cusvariavel, 0), nvl(cussemicm, 0), nvl(cusmedicm, 0),
    ...
    into r.cusrep, r.cusger, r.cusvariavel, r.cussemicm, r.cusmedicm, r.entradasemicms, r.entradacomicms,
         r.cusmed
    from tgfcus c0
 ...
 function removerduplicidade(p_texto varchar2, p_caracter char) return varchar2 is
 ...
 function valorprodcontrato(p_numcontrato number, p_codprod number) return float is
  v_vlrunit float;
 ...
 function nome_parceiro(p_codparc number, p_tiponome varchar2) return varchar2 is
 ...
 function aliq_piscofins(p_codprod number, p_nomeimp varchar2, p_top number) return float is
 ...
 function ultimo_valor_contrato(p_numcontrato number, p_codprod number, p_data date) return float is
 ...
 function cotacao_moeda(p_codmoeda number, p_dtref date) return float is
  v_result float;
 begin
 ...
 function meses_entre_datas(p_dtini date, p_dtfin date) return number is
  v_meses number;
 begin
 ...
 begin
  ...
  select e.nomefantasia into v_nomeempresa from tsiemp e where e.codemp = p_codemp;
 ...
 function ult_valor_moeda_ref(p_codmoeda int, p_dtref date) return float is
  v_result float;
 begin
  select cotacao
    into v_result
